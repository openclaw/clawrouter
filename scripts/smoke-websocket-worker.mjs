...
try {
  ...
  assert.equal((await authorityObject.fetch("https://authority/credentials/put", { method: "POST", body: JSON.stringify({ credentialId: "fixture", credential: { ...credential, principalId: owner.email } }) })).status, 200);
