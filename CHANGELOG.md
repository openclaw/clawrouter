...
- Reserve DeepSeek's full declared output bound unless a valid native `max_tokens` lowers it, including Fusion readiness. Normalize inclusive Chat cache hits without double-counting input or discounting conflicting counters.
