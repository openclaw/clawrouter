...
- Reconcile pending policy saves by field after reselection or discard, preserving newer edits without rolling back untouched disabled state, budget, or provider settings on the next save.
