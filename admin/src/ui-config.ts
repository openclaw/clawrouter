...
export function applyTheme(theme: Theme) {
  ...
  document.querySelector<HTMLMetaElement>('meta[name="theme-color"]')?.setAttribute("content", theme === "dark" ? "#0c0e11" : "#f2f0ea");
...
export const defaultPolicy: PolicyForm = {
  ...
  grantSwitchAtUsedPercent: "90",
  grantHysteresisPercent: "10",
  eligibleGrants: "",
};
...
export const defaultUpstreamGrant: UpstreamGrantForm = { scope: "policies", scopeId: "", tokenRef: "", kind: "api_key", provider: "", label: "", enabled: true, priority: "100", weight: "1", credential: "", credentialBundle: "", accessToken: "", refreshToken: "", removeRefreshToken: false, accountId: "", expiresAt: "", keepWarm: false };
