...
for (const [name, route, requestedTier, payload, contentType, expected, servedTier, outcome = "success", fixedCost = null] of [
  ...
  ["large JSON fixed tariff", "/v1/responses", "priority", { output: largeResponsesOutput, object: "response", status: "completed", service_tier: "priority", usage: astraUsage }, "application/json", 7, "priority", "success", 7],
