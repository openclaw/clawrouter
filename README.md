...
For Codex, use the [native catalog export and provider setup](docs/codex.md), including Fast tier accounting, qualified Responses WebSockets, and desktop account boundaries.
